...
public class ServerBootstrap {
    ...
    public static void main(String[] args) {
        //注册服务到注册中心
        InetSocketAddress serviceAddress = new InetSocketAddress("127.0.0.1", 7000);
        ServerBootstrap.serviceRegistry.registerService("github.kevssim.service.HelloService", serviceAddress);
        //创建netty服务端
